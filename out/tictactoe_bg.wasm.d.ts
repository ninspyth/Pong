...
export function wasm_bindgen__convert__closures__invoke1_mut__h078113f2c0e42923(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h5bd2ad08cea78dc0(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha4f1b68fbc7cf68c(a: number, b: number, c: number): void;
